...
export default function Content() {
  ...
  return (
    <section name="projects" className="bg-[papayawhip] pb-14">
      <h1 className="text-6xl lg:text-7xl pt-10 pl-6 font-semibold">
        Projects
      </h1>
      <h2 className="pt-4 pl-6 lg:text-2xl">Some of my personal projects</h2>
