...
export default function Header() {
  return (
    <div name="home" className="bg-black">
      ...
      <div
        name="about"
        className="flex flex-col justify-center items-start gap-4 lg:flex-row lg:items-center lg:px-40 lg:gap-16 bg-black text-white pt-6 lg:pt-[6rem] pb-[5rem] pl-3 lg:mt-[3rem]"
      >
        <img
