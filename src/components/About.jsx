...
export default function Content() {
  ...
  return (
    <section name="about" className="mt-0 lg:mt-[6rem] pt-[13rem] pb-[4rem] px-4 lg:px-[8rem] lg:pb-[8rem] bg-black text-white lg:flex justify-center gap-8">
      <img src="/assets/Prajwal.jpg" className="text-center mt-[-6rem] h-[25rem] w-[18rem] m-auto rounded-[2rem] lg:h-[32rem] lg:w-[28rem] hover:scale-105 duration-500" alt="prajwal"/>
